...
export function Icon({ name, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      {name === "plane" && (
        <path d="m3.5 13.2 7.1 1.1 3.9 6.2 1.8-.6-1.7-6.5 4.5-1.4c1.5-.5 2.3-1.5 1.9-2.6-.4-1.2-1.7-1.4-3.2-.9l-4.5 1.4-2.5-6.2-1.8.6.5 7.3-6.6 2.2.6-.6Z" fill="currentColor" />
      )}
      {name === "pin" && (
        <>
